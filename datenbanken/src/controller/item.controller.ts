...
export function createItemRouter(db: Pool) {
	...
	// Alle Inventargegenstände abrufen
	...
	// Neuen Inventargegenstand erstellen
	...
	// Einen spezifischen Inventargegenstand abrufen
	...
	// Einen Inventargegenstand aktualisieren
	...
	// Einen Inventargegenstand löschen
