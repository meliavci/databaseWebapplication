			...
			<div class="mx-auto px-4 pt-30 pb-20 max-w-7xl sm:px-6 lg:px-8 py-12">
				<div class="text-center mb-12">
					...
					<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						<div class="group cursor-pointer transition-all duration-300 transform hover:-translate-y-2 overflow-hidden rounded-xl border border-neutral-700 p-6 items-start text-start">
							<div class="relative aspect-square p-6">
								<img src="/Product1.png" alt="Product"
									class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
								/>
								<div class="absolute top-1 left-1 border border-neutral-700 px-5 py-1 rounded-full text-sm text-white">
									Gaming
								</div>
							</div>
							<div class="p-4">
