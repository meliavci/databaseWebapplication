...
@Component({
    ...
    <div *ngIf="selectedMethod === 'card'" class="space-y-4">
      <div>
        ...
        <input type="text" id="cardholder" class="w-full border border-neutral-700 rounded-md p-2 focus:ring-primary-500 focus:border-primary-500 text-gray-400 px-5" placeholder="Enter cardholder name">
      </div>
      <div>
        <label for="cardnumber" class="block text-sm font-medium text-gray-300 mb-1">Card Number</label>
        <input type="text" id="cardnumber" class="w-full border border-neutral-700 rounded-md p-2 focus:ring-primary-500 focus:border-primary-500 text-gray-400 px-5" placeholder="Enter card number" maxlength="19">
      </div>
      <div class="grid grid-cols-2 gap-4">
        <div>
          <label for="expiry" class="block text-sm font-medium text-gray-300 mb-1">Expiration Date</label>
          <input type="text" id="expiry" class="w-full border border-neutral-700 rounded-md p-2 focus:ring-primary-500 focus:border-primary-500 text-gray-400 px-5" placeholder="MM/YY" maxlength="7">
        </div>
        <div>
          <label for="cvv" class="block text-sm font-medium text-gray-300 mb-1">CVV</label>
          <input type="text" id="cvv" class="w-full border border-neutral-700 rounded-md p-2 focus:ring-primary-500 focus:border-primary-500 text-gray-400 px-5" placeholder="Enter CVV" maxlength="4">
        </div>
      </div>
    </div>
